...
import CrimeSceneInvestigator.Tuplets.Behoerden;
...
public class Control_Behoerden extends MainController {
    ...
    public Control_Behoerden() {
        ...
        attr = new String[Behoerden.attr.length];
        System.arraycopy(Behoerden.attr, 0, attr, 0, attr.length);
    ...
    void save(ActionEvent actionEvent) {
        ...
        if (isNew) {
            Tuplet tuplet = new Behoerden(val);
