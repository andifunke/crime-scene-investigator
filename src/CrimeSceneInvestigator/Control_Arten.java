...
import CrimeSceneInvestigator.Tuplets.Arten;
...
public class Control_Arten extends MainController {
    ...
    public Control_Arten() {
        ...
        attr = new String[Arten.attr.length];
        System.arraycopy(Arten.attr, 0, attr, 0, attr.length);
