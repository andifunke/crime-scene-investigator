...
public class MainController extends SplitPane {
	...
	TextField textAttr0;
	@FXML
	TextField filterAttr0;
	@FXML
	Label labelAttr0;
	@FXML
	TableColumn columnAttr0;

	@FXML
	TextField textAttr1;
	@FXML
	TextField filterAttr1;
	@FXML
	Label labelAttr1;
	@FXML
	TableColumn columnAttr1;

	@FXML
	TextField textAttr2;
	@FXML
	TextField filterAttr2;
	@FXML
	Label labelAttr2;
	@FXML
	TableColumn columnAttr2;

	@FXML
	TextField textAttr3;
	@FXML
	TextField filterAttr3;
	@FXML
	Label labelAttr3;
	@FXML
	TableColumn columnAttr3;

	@FXML
	TextField textAttr4;
	@FXML
	TextField filterAttr4;
	@FXML
	Label labelAttr4;
	@FXML
	TableColumn columnAttr4;

	@FXML
	TextField textAttr5;
	@FXML
	TextField filterAttr5;
	@FXML
	Label labelAttr5;
	@FXML
	TableColumn columnAttr5;

	@FXML
	TextField textAttr6;
	@FXML
	TextField filterAttr6;
	@FXML
	Label labelAttr6;
	@FXML
	TableColumn columnAttr6;
	...
	@FXML
	ListView<Tuplet> list0;
	@FXML
	Label labelList0;
	ObservableList<Tuplet> ol0;

	@FXML
	ListView<Tuplet> list1;
	@FXML
	Label labelList1;
	ObservableList<Tuplet> ol1;

	@FXML
	ListView<Tuplet> list2;
	@FXML
	Label labelList2;
	ObservableList<Tuplet> ol2;

	@FXML
	ListView<Tuplet> list3;
	@FXML
	Label labelList3;
