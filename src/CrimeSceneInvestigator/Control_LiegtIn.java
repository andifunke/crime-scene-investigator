...
import CrimeSceneInvestigator.Tuplets.liegtin;
...
public class Control_liegtin extends MainController {
    ...
    public Control_liegtin() {
        ...
        attr = new String[liegtin.attr.length];
        System.arraycopy(liegtin.attr, 0, attr, 0, attr.length);

        attrName = new String[attr.length];
        attrName[0] = "Unterbezirk";
        attrName[1] = "Oberbezirk";
        ...
        labelList[0].setText("Unterbezirk");
        labelList[1].setText("Oberbezirk");
    ...
    void setUpLists() {
        ...
        String query0 =
              "SELECT * FROM Bezirke WHERE BezirkID = '" + val[0] + "';";
        ol0 = SQLController.selectFromQuery(listTable[0], query0);
        list0.setItems(ol0);

        String query1 =
              "SELECT * FROM Bezirke WHERE BezirkID = '" + val[1] + "';";
